...
const data = [
  {
    ...
    content: (
      <>
        <Image src={photo01} alt="" width="854" height="359" layout="responsive" />
  ...
  },
  {
    ...
    content: (
      <>
        <Image src={photo04} alt="" width="854" height="359" layout="responsive" />
        <Text fontSize="20px" lineHeight="1.6em">
        ...
        <Image src={photo05} alt="" width="854" height="359" layout="responsive" />
      </>
    ),
  },
  {
    ...
    content: (
      <>
        {/* <Image src={photo02} alt="" width="854" height="359" layout="responsive" /> */}
        <Text fontSize="20px" lineHeight="1.6em">
        ...
        {/* <Image src={photo03} alt="" width="854" height="359" layout="responsive" /> */}
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <Image src={photo06} alt="" width="854" height="359" layout="responsive" />
        <Text fontSize="20px" lineHeight="1.6em">
        ...
        <Image src={photo07} alt="" width="854" height="359" layout="responsive" />
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <Image src={photo08} alt="" width="854" height="359" layout="responsive" />
        <Text fontSize="20px" lineHeight="1.6em">
        ...
        <Image src={photo09} alt="" width="854" height="359" layout="responsive" />
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        <Image src={photo10} alt="" width="854" height="359" layout="responsive" />
        <Text fontSize="20px" lineHeight="1.6em">
          新勝景掌中劇團1996年創團成立於臺中豐原， 前身為朱清貴掌中劇團， 第一代團主為朱清貴先生，目前劇團由第二代團主朱勝珏接任。
        </Text>
        <Image src={photo11} alt="" width="854" height="359" layout="responsive" />
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <Image src={photo13} alt="" width="854" height="359" layout="responsive" />
        <Text fontSize="20px" lineHeight="1.6em">
        ...
        <Image src={photo12} alt="" width="854" height="359" layout="responsive" />
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <Image src={photo14} alt="" width="854" height="359" layout="responsive" />
        <Text fontSize="20px" lineHeight="1.6em">
        ...
        <Image src={photo15} alt="" width="854" height="359" layout="responsive" />
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <Image src={photo16} alt="" width="854" height="359" layout="responsive" />
        <Text fontSize="20px" lineHeight="1.6em">
        ...
        <Image src={photo17} alt="" width="854" height="359" layout="responsive" />
      </>
    ),
  },
]
